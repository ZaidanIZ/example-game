...
public class gamePlayManager : MonoBehaviour {
	...
	void Start () {
		...
		avatar = characterSelector.transform.Find ("avatar").GetComponent<Image>(); // avatar object
		nextCharacterButton = characterSelector.transform.Find ("right").gameObject; // determines variables
		prevCharacterButton = characterSelector.transform.Find ("left").gameObject;
		nextMapButton = mapSelector.transform.Find ("right").gameObject;
		prevMapButton = mapSelector.transform.Find ("left").gameObject;
		disableAudioButton = inGameMenu.transform.Find ("disableAudio").gameObject;
		enableAudioButton = inGameMenu.transform.Find ("enableAudio").gameObject;
		coinsBar = GameObject.Find ("money").transform.Find("Text").gameObject.GetComponent<Text>();
		coinsBar.text = "" + PlayerPrefs.GetFloat("coins");
		distanceBar = gameButtons.transform.Find ("distanceBar").gameObject.GetComponent<Text> ();
	...
	void refreshMapSelection ()
	{
		...
		GameObject buyButton = mapSelector.transform.Find ("buy").gameObject; // determines selection buttons
		GameObject selectButton = mapSelector.transform.Find ("select").gameObject; // determines selection buttons
		
		if (!maps [mapNum].opened) // if map is not available
		{
			selectButton.SetActive (false);
			buyButton.SetActive (true);
			buyButton.transform.Find ("Text").gameObject.GetComponent<Text> ().text = "" + maps [mapNum].price;
