...
public class characterBehaviour : MonoBehaviour {
	...
	void Start () {
		...
		healthLine = GameObject.Find ("Canvas").transform.Find ("gameUI").Find ("healthBar").Find ("line").gameObject.GetComponent<RectTransform> ();  // determine health bar
	...
	{
		an.SetInteger ("state", 1); // sets movement animation
	...
	void checkForStanding ()
	{
		...
		{
			an.SetInteger ("state", 0); // sets idle animation
		}
	}
	...
	{
		weaponContainer = transform.Find ("weapon"); // finds weapon container
