...
public class touchInputManager : MonoBehaviour {
	...
	void Start () {
		startMoveButtonPosition = GameObject.Find ("Canvas").transform.Find ("gameUI").Find ("moveButton").position;
		startShootButtonPosition = GameObject.Find ("Canvas").transform.Find ("gameUI").Find ("shootButton").position;
	}
