...
namespace EasyMobile.Editor
{
    ...
    public partial class EM_SettingsEditor : UnityEditor.Editor
    {
        ...
        {
            public static SerializedProperty mainProperty;
            public static EMProperty iosDialogContent = new EMProperty(null, new GUIContent("[iOS pre-10.3] Dialog Content", "Content settings for the rating dialog used on iOS versions before 10.3"));
            public static EMProperty androidDialogContent = new EMProperty(null, new GUIContent("[Android] Dialog Content", "Content settings for the rating dialog used on Android"));
        ...
        void OnEnable()
        {
            ...
            RatingRequestProperties.iosDialogContent.property = RatingRequestProperties.mainProperty.FindPropertyRelative("_iosDialogContent");
            RatingRequestProperties.androidDialogContent.property = RatingRequestProperties.mainProperty.FindPropertyRelative("_androidDialogContent");
