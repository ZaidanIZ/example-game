...
namespace EasyMobile.Editor
{
    ...
    public class EM_Manager : AssetPostprocessor
    {
        ...
        private static void Initialize()
        {
            ...
            // including importing the native package.
            VersionCheck();
        ...
        internal static void VersionCheck()
        {
            ...
            if (savedVersion != EM_Constants.versionInt)
            {
                ...
                // Import new native package
                ImportNativeCode();
            }
            else if (!IsNativeCodeImported())
            {
                ImportNativeCode();
            }
        }

        internal static bool IsNativeCodeImported()
        {
            return EM_ProjectSettings.Instance.GetBool(EM_Constants.PSK_ImportedNativeCode, false);
        }

        internal static void ImportNativeCode()
        {
